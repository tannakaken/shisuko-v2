...
curl -L -H "Accept: application/vnd.github+json" -H "Authorization: token $GITHUB_TOKEN" -H "X-GitHub-Api-Version: 2022-11-28" -H 'Content-Type: application/pdf' -X POST "${assets_url}?name=詩晒古_第二号.pdf" --upload-file '詩晒古_第二号.pdf'